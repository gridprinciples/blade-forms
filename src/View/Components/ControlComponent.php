...
abstract class ControlComponent extends Component
{
    ...
    public function __construct(
        ...
        public string|Htmlable|null|ComponentSlot $label = new ComponentSlot,
        public string|Htmlable|null|ComponentSlot $help = new ComponentSlot,
        public ?ComponentSlot $wrapper = new ComponentSlot,
        public ?ComponentSlot $inputGroup = new ComponentSlot,
